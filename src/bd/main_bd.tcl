...
################################################################
# This is a generated script based on design: design_ddr
#
...
set design_name design_quickscope
...
proc write_mig_file_design_ddr_mig_7series_0_1 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>design_ddr_mig_7series_0_1</ModuleName>}
...
# End of write_mig_file_design_ddr_mig_7series_0_1()
...
proc create_root_design { parentCell } {
  ...
  set rotary_Button [ create_bd_port -dir I rotary_Button ]
  ...
  set vauxn8_0 [ create_bd_port -dir I vauxn8_0 ]
  set vauxp8_0 [ create_bd_port -dir I vauxp8_0 ]
  set vauxn9_0 [ create_bd_port -dir I vauxn9_0 ]
  set vauxp9_0 [ create_bd_port -dir I vauxp9_0 ]
  ...
  # Create instance: axi4lite_rotary_0, and set properties
  set block_name axi4lite_rotary
  set block_cell_name axi4lite_rotary_0
  if { [catch {set axi4lite_rotary_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi4lite_rotary_0 eq "" } {
  ...
  write_mig_file_design_ddr_mig_7series_0_1 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins axi4lite_rotary_0/s_axi]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  ...
  # Create port connections
  connect_bd_net -net axi4lite_rotary_0_o_interrupt [get_bd_pins axi4lite_rotary_0/o_interrupt] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net i_a_0_1 [get_bd_ports rotary_A] [get_bd_pins axi4lite_rotary_0/i_a]
  connect_bd_net -net i_b_0_1 [get_bd_ports rotary_B] [get_bd_pins axi4lite_rotary_0/i_b]
  connect_bd_net -net i_button_0_1 [get_bd_ports rotary_Button] [get_bd_pins axi4lite_rotary_0/i_button]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/S02_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi4lite_rotary_0/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk]
  ...
  connect_bd_net -net proc_sys_reset_0_mb_reset [get_bd_pins proc_sys_reset_0/mb_reset] [get_bd_pins microblaze_0/Reset]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi4lite_rotary_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S02_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins reset_inv_0/Op1] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins reset_inv_0/Res] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net sys_clock_1 [get_bd_ports clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net vauxn0_0_1 [get_bd_ports vauxn0_0] [get_bd_pins xadc_wiz_0/vauxn0]
  connect_bd_net -net vauxn1_0_1 [get_bd_ports vauxn1_0] [get_bd_pins xadc_wiz_0/vauxn1]
  connect_bd_net -net vauxn8_0_1 [get_bd_ports vauxn8_0] [get_bd_pins xadc_wiz_0/vauxn8]
  connect_bd_net -net vauxn9_0_1 [get_bd_ports vauxn9_0] [get_bd_pins xadc_wiz_0/vauxn9]
  connect_bd_net -net vauxp0_0_1 [get_bd_ports vauxp0_0] [get_bd_pins xadc_wiz_0/vauxp0]
  connect_bd_net -net vauxp1_0_1 [get_bd_ports vauxp1_0] [get_bd_pins xadc_wiz_0/vauxp1]
  connect_bd_net -net vauxp8_0_1 [get_bd_ports vauxp8_0] [get_bd_pins xadc_wiz_0/vauxp8]
  connect_bd_net -net vauxp9_0_1 [get_bd_ports vauxp9_0] [get_bd_pins xadc_wiz_0/vauxp9]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins xadc_wiz_0/eoc_out] [get_bd_pins xlconcat_0/In1]
  ...
  assign_bd_address -offset 0xC0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi4lite_rotary_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi4lite_rotary_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x41400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs mdm_1/S_AXI/Reg] -force
