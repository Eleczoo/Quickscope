...
################################################################
# This is a generated script based on design: design_quickscope
#
...
# source design_quickscope_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axi4lite_rotary, axi4lite_framebuffer, video_generator
...
proc write_mig_file_design_quickscope_mig_7series_0_0 { str_mig_prj_filepath } {
...
# End of write_mig_file_design_quickscope_mig_7series_0_0()
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_net -net axi4lite_framebuffer_0_assets_dob [get_bd_pins axi4lite_framebuffer_0/assets_dob] [get_bd_pins video_generator_0/assets_dob]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PixelClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins axi4lite_framebuffer_0/pxlclk] [get_bd_pins video_generator_0/pxlclk]
  connect_bd_net -net reset_0_1 [get_bd_pins reset] [get_bd_pins rgb2dvi_0/aRst]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi4lite_framebuffer_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi4lite_framebuffer_0/s_axi_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins rst_n] [get_bd_pins video_generator_0/rst_n]
  connect_bd_net -net video_generator_0_assets_addrb [get_bd_pins video_generator_0/assets_addrb] [get_bd_pins axi4lite_framebuffer_0/assets_addrb]
  connect_bd_net -net video_generator_0_assets_enb [get_bd_pins video_generator_0/assets_enb] [get_bd_pins axi4lite_framebuffer_0/assets_enb]
...
proc create_root_design { parentCell } {
  ...
  write_mig_file_design_quickscope_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins video/s_axi]
  ...
  # Create port connections
  connect_bd_net -net PixelClk_1 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins video/PixelClk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/S02_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins axi4lite_rotary_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins video/s_axi_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S02_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins axi4lite_rotary_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins video/s_axi_aresetn]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins reset_inv_0/Op1] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins video/rst_n]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins reset_inv_0/Res] [get_bd_pins clk_wiz_0/reset] [get_bd_pins video/reset]
  ...
  assign_bd_address -offset 0x20000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs video/axi4lite_framebuffer_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x20000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs video/axi4lite_framebuffer_0/s_axi/reg0] -force
